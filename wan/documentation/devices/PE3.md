...
!
management security
  session shared-secret profile KEYCHAIN
...
interface Ethernet2
  ...
  isis enable IGP
  isis network point-to-point
  isis authentication mode shared-secret profile KEYCHAIN algorithm md5
  traffic-engineering min-delay static 10 milliseconds
!
interface Ethernet5
  description CE1
...
!
monitor session 1 source Ethernet5
!
...
patch panel
  ...
  !
  patch subintpo5.301
      connector 1 interface Ethernet5.301
      connector 2 pseudowire bgp vpws SVC3-VPWS-DOUBLE-2 pseudowire pw1
!
policy-map type quality-of-service POLICE_100MBPS
  class class-default
!
route-map BLOCK_ALL deny 5
!
route-map BLOCK_ALL permit 10
!
route-map BLOCK_IN_MAINT deny 5
...
router bgp 65000
  ...
  vpws SVC3-VPWS-DOUBLE-2
      ...
      !
      pseudowire pw1
        evpn vpws id local 10301 remote 20301
  !
  address-family evpn
